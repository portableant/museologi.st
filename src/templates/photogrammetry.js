...
export const Head = (props) => (
    <Seo title={"My photogrammetry and 3d scanning work , page " + props.pageContext.humanPageNumber} description={"An overview of my photogrammetry work around the world"}/>
)